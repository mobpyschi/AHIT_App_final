            ...
            <div class="col-md-8">
                <div class="card-box task-detail">
                    ...
                    <div class="media mb-3">
                        <img class="d-flex mr-3 rounded-circle avatar-md" alt="64x64" src="/images/users/user-2.jpg">
                    ...
                    <div>
                        ...
                        <div class="media mb-3">
                            <div class="d-flex mr-3">
                                <a href="#"> <img class="media-object rounded-circle avatar-sm" alt="64x64" src="/images/users/user-1.jpg"> </a>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media mb-3">
                            <div class="d-flex mr-3">
                                <a href="#"> <img class="media-object rounded-circle avatar-sm" alt="64x64" src="/images/users/user-2.jpg"> </a>
                            </div>
                            <div class="media-body">
                                ...
                                <div class="media my-2">
                                    <div class="d-flex mr-3">
                                        <a href="#"> <img class="media-object rounded-circle avatar-sm" alt="64x64" src="/images/users/user-3.jpg"> </a>
                                    </div>
                                    <div class="media-body">
