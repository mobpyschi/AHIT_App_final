                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            <div class="mr-2 align-self-center">
                                <img src="images/users/user-1.jpg" alt="" class="rounded-circle avatar-sm">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <p class="font-13 text-muted mb-0"><i class="mdi mdi-circle text-success mr-1 font-11"></i>
                                    Active</p>
                            </div>
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle arrow-none card-drop font-20" data-toggle="dropdown"
                                    aria-expanded="false">
                                    <i class="mdi mdi-dots-vertical"></i>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
