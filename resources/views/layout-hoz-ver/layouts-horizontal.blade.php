...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Horizontal Layout | Adminto - Responsive Bootstrap 4 Admin Dashboard</title>
                    ...
                    <div class="container-fluid">
                        <ul class="list-unstyled topnav-menu float-right mb-0">
                                    ...
                                    <div class="slimscroll noti-scroll">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                            <div class="notify-icon">
                                                <img src={{ URL::asset("images/users/user-1.jpg")}} class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src={{ URL::asset("images/users/user-4.jpg")}} class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src={{ URL::asset("images/users/user-1.jpg")}} alt="user-image" class="rounded-circle">
                        ...
                        <div class="logo-box">
                            <a href="index.html" class="logo logo-light">
                                <span class="logo-lg">
                                    <img src={{ URL::asset("images/logo-light.png")}} alt="" height="16">
                                </span>
                                <span class="logo-sm">
                            ...
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-lg">
                                    <img src={{ URL::asset("images/logo-dark.png")}} alt="" height="16">
                                </span>
                                <span class="logo-sm">
                                    <img src={{ URL::asset("images/logo-sm.png")}} alt="" height="24">
                                </span>
                                ...
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src={{ URL::asset("images/users/user-3.jpg")}} class="img-fluid rounded-circle" alt="user">
                                        </div>
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget">
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="images/users/user-1.jpg" class="rounded-circle" alt=""></div>
