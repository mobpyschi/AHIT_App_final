...
$(function() {
    ...
    var calendar = $("#calendar").fullCalendar({
        ...
        select: function(start, end, allDay) {
            ...
            i.append("<div class='row'></div>"),
                i
                    ...
                    .append(
                        "<div class='col-md-6'><div class='form-group'><label class='control-label'>Start</label><input class='form-control' type='datetime-local' name='start' ></div></div>"
                    )
                    .append(
                        "<div class='col-md-6'><div class='form-group'><label class='control-label'>End</label><input class='form-control' type='datetime-local' name='end'></div></div>"
                    )
                    .append(
                ...
                o.$modal.find("form").on("submit", function() {
                    var e = i.find("input[name='title']").val(),
                        t = i
                            ...
                            .val(),
                        t1 = i.find("input[name='start']").val(),
                        t2 = i.find("input[name='end']").val(),
        ...
        eventClick: function(event, allDay) {
            $("#event-update-modal").modal({ backdrop: "static" });
            var i = $("<form></form>");
            i.append("<div class='row'></div>"),
                i
                    .find(".row")
                    ...
                    .append(
                        "<div class='col-md-6'><div class='form-group'><label class='control-label'>Start</label><input class='form-control' type='datetime-local' name='start' value=" +
                            Date(
                                "YYYY-MM-DDTHH:mm",
                ...
                .click(function() {
                    ...
                    (start = moment(event.start).format()),
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                displayMessage("Event Update Successfully");
                                calendar.fullCalendar(
                                    "renderEvent",
                                    {
                                        id: data.id,
