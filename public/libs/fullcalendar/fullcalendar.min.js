    ...
    return (function(t) {
                        ...
                        (t.prototype.unbind = function() {
                            this.stopListeningTo(r(document)),
                                window.removeEventListener(
                                    "touchmove",
                                    this.handleTouchMoveProxy, { passive: !1 }
                                ),
                                window.removeEventListener(
                                    "scroll",
                ...
                p = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.skipHiddenDays = function(t, e, n) {
                            void 0 === e && (e = 1), void 0 === n && (n = !1);
                            for (
                                var r = t.clone(); this.isHiddenDayHash[
                                    (r.day() + (n ? e : 0) + 7) % 7
                                ];
                    ...
                    return (
                        ...
                        (t.prototype._getTimeText = function(t, e, n, r, i) {
                            return (
                                ...
                                i && e ?
                                this.view.formatRange({ start: t, end: e }, !1,
                                    r
                                ) :
                                t.format(r) :
                                ""
                    ...
                    return (
                        ...
                        (e.prototype.unset = function(t) {
                            var e,
                                ...
                                r = {};
                            for (
                                e = "string" == typeof t ? [t] : t, n = 0; n < e.length; n++
                            )
                                r[e[n]] = void 0;
                            this.setProps(r);
                        }),
                    ...
                    return (
                        ...
                        (e.parse = function(t, e) {
                            ...
                            return (
                                i.isArray(t.events) ?
                                (n = t) :
                                i.isArray(t) && (n = { events: t }), !!n && a.default.parse.call(this, n, e)
                            );
                        }),
                        ...
                        (e.prototype.renderNumberCellHtml = function(t) {
                            ...
                            return s || this.cellWeekNumbersVisible ?
                                ((e = this.getDayClasses(t)),
                                    ...
                                    this.cellWeekNumbersVisible &&
                                    t.day() === n &&
                                    (i += r.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" },
                                        t.format("w")
                                    )),
                                    s &&
                        ...
                        (e.prototype.limitRow = function(t, e) {
                            ...
                            if (e && e < b.segLevels.length) {
                                for (
                                    ...
                                    for (
                                        a = n[s], E(a.leftCol), d = [], u = 0; D <= a.rightCol;
                    ...
                    return (
                        ...
                        (e.parse = function(t, e) {
                            ...
                            return (
                                ...
                                (n = t) :
                                i.isFunction(t) && (n = { events: t }), !!n && s.default.parse.call(this, n, e)
                            );
                        }),
                        (e.prototype.fetch = function(t, e, n) {
                            var r = this;
                ...
                u = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.computeSelection = function(t, e) {
                            ...
                            return (!(n && !this.isSelectionFootprintAllowed(n)) &&
                                n
                            );
                        }),
        ...
        function(t, e, n) {
            function r(t) {
                ...
                for (e = 0; e < t.length; e++) {
                    for (
                        n = t[e], r = 0; r < i.length && s(n, i[r]).length; r++
                    );
            ...
            function i(t) {
                ...
                for (e = 0; e < t.length; e++)
                    for (n = t[e], r = 0; r < n.length; r++)
                        for (
                            i = n[r], i.forwardSegs = [], o = e + 1; o < t.length; o++
                        )
                    ...
                    return (
                        ...
                        (e.prototype.renderSegRows = function(t) {
                            var e,
                                ...
                                r = [];
                            for (
                                e = this.groupSegRows(t), n = 0; n < e.length; n++
                            )
                        ...
                        (e.prototype.buildSegLevels = function(t) {
                            var e,
                                ...
                                s = [];
                            for (
                                this.sortEventSegs(t), e = 0; e < t.length; e++
                            ) {
                                for (
                                    n = t[e], o = 0; o < s.length && r(n, s[o]); o++
                                );
                    ...
                    return (
                        ...
                        (e.prototype.renderDates = function(t) {
                            for (
                                var e = this.calendar,
                                    n = e.msToUtcMoment(
                                        t.renderUnzonedRange.startMs, !0
                                    ),
                                    r = e.msToUtcMoment(
                                        t.renderUnzonedRange.endMs, !0
                                    ),
                                    i = [],
                                    o = []; n < r;
